...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\x05items\x18\x02 \x03(\v2\x16.shipping.ShippingItemR\x05items\"X\n" +
	"\x16CreateShippingResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12#\n" +
	"\rdelivery_days\x18\x02 \x01(\x05R\fdeliveryDays2W\n" +
	"\bShipping\x12K\n" +
	"\x06Create\x12\x1f.shipping.CreateShippingRequest\x1a .shipping.CreateShippingResponseB8Z6github.com/agu3des/microservices-proto/golang/shippingb\x06proto3"
